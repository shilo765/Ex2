...
public class Ex2_Client implements Runnable{
	...
	public void run() {
		...
		try {
			gg = getGraphFromJson(game.getGraph()).getGraph();
	 ...
	 * @param
	 */
	private static game_service moveAgants(game_service game, directed_weighted_graph gg) {
		String lg = game.move();
